...
class MenuDrawer(IDrawable):
    ...
    def __init__(self, screen, settings):
        ...
        # Налаштування області попереднього перегляду автомобіля
        self.car_preview_pos = (480, 120)
        self.car_preview_size = (180, 360)
        
        # Кеш для зображень (щоб не завантажувати їх щокадру)
        self.car_images = {}
        self.background_images = {}
        
        # Попереднє завантаження ресурсів у пам'ять
    ...
    def draw(self, menu):
        ...
        """
        # 1. Малювання фонового зображення
        ...
        # 2. Малювання напівпрозорих накладок (Overlay) для кращої читабельності тексту
        if menu.mode == "main":
        ...
        # 3. Відображення пунктів Головного Меню
        if menu.mode == "main":
        ...
        # 4. Відображення налаштувань та прев'ю авто
        ...
        # 5. Відображення оверлеїв паузи та кінця гри
